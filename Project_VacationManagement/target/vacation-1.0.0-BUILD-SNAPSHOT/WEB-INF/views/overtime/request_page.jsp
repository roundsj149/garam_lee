	...
	<div class="request-box">
		...
		<form id="frm">
			...
			<div class="form-content">
			    ...
			    <div id="sTimeBox" class="time-box">
			    	<select class="form-control select-box" name="sHour" id="sHour">
			    		<option selected>--</option>
			    		<c:forEach var="i" begin="0" end="23">
			    			<option value="${i }">${i }</option>
			    		</c:forEach>
			    	</select>시
			    	<select class="form-control select-box" name="sMinute" id="sMinute">
			    		<option selected>--</option>
			    		<c:forEach var="i" begin="00" end="50" step="10">
			    			<option>${i }</option>
			    		</c:forEach>
			    	</select>분
			    </div>
			...
			<div class="form-content">
			    ...
			    <div id="eTimeBox" class="time-box">
			    	<select class="form-control select-box"  name="eHour" id="eHour">
			    		<option selected>--</option>
			    		<c:forEach var="i" begin="0" end="23">
			    			<option value="${i }">${i }</option>
			    		</c:forEach>
			    	</select>시
			    	<select class="form-control select-box" name="eMinute" id="eMinute">
			    		<option selected>--</option>
			    		<c:forEach var="i" begin="00" end="50" step="10">
			    			<option value="${i }">${i }</option>
			    		</c:forEach>
			...
			<div class="form-content">
			    <label for="fullname">근무형태</label>
			    <div id="radioBtn" class="btn-group btn-group-toggle radio-button" data-toggle="buttons">
					<label class="btn btn-secondary active">
						<input type="radio" name="overtimeType" id="holiday" value="HOLIDAY"> 휴일
					</label>
					<label class="btn btn-secondary">
						<input type="radio" name="overtimeType" id="overnight" value="OVERNIGHT"> 철야
					</label>
				</div>
			</div>
			<div class="form-content">
			    <label for="fullname">업무내용</label>
			    <textarea rows="6" id="overtimeContent" class="form-control"></textarea>
			</div>
