...
<div class="container">
	<div class="login-box">
		<div class="title-box">
			...
			<div class="logo"><h3>비밀번호 변경</h3></div>
		</div>
		<form id="frm">
			<div class="form-content">
				<label for="currPw">현재 비밀번호</label>
			    <input type="password" class="form-control" id="currPw" name="currPw" placeholder="현재 비밀번호"
			    	onfocus="this.placeholder=''" onblur="this.placeholder='현재 비밀번호'">
			    <div class="curr-pw-blank">현재 비밀번호를 입력해주세요.</div>
			</div>
			<div class="form-content">
			    <label for="newPw">변경할 비밀번호</label>
			    <input type="password" class="form-control" id="newPw" name="newPw" placeholder="변경할 비밀번호(8자리 이상)"
			    	onfocus="this.placeholder=''" onblur="this.placeholder='변경할 비밀번호(8자리 이상)'">
			    <div class="new-pw-blank">변경할 비밀번호를 입력해주세요.</div>
			</div>
			<div class="form-content">
			    <label for="newPwCheck">비밀번호 확인</label>
			    <input type="password" class="form-control" id="newPwCheck" name="newPwCheck" placeholder="비밀번호 확인"
			    	onfocus="this.placeholder=''" onblur="this.placeholder='비밀번호 확인'">
			    <div class="new-pw-check-blank">비밀번호를 확인해주세요.</div>
			</div>
			<div class="form-content">
			    <div class="info-check alert alert-danger" role="alert"></div>
			</div>
			<div class="form-content btns">
			    <input type="button" id="updatePwConfirmBtn" class="btn btn-warning" value="변경하기">
			    <a href="/member/list">
