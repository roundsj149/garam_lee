$(function() {
	...
	function requestProcess() {
		...
		var formData = {
			...
			"startHour": $("#sHour").prop("selected", true).val(),
			"startMinute": $("#sMinute").prop("selected", true).val(),
			"endDt": $("#endDate").val(),
			"endHour": $("#eHour").prop("selected", true).val(),
			"endMinute": $("#eMinute").prop("selected", true).val(),
		...
		$.ajax({
			...
			success: function(data) {
				console.log(data);
				//console.log("초과근무 신청 결과: " + data.baseResult.returnCode);
