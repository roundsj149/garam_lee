...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/js/admin/member_blacklist_page.js"></script>
</head>
          ...
          <div class="col-12">
            <div class="card">
            	<ul class="nav nav-tabs">
				  	<li class="nav-item">
			 	   		<a class="nav-link" href="${pageContext.request.contextPath}/admin/member_list_page.do">회원리스트</a>
				  	</li>
				  	<li class="nav-item">
				    	<a class="nav-link active" href="${pageContext.request.contextPath}/admin/member_blacklist_page.do">블랙리스트</a>
				  	</li>
				</ul>
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody id="member_blacklist">
                  	<!-- 신고 리스트 -->
                  </tbody>
                </table>
              </div>
              <div id="paginationbox">
	  			<ul class="pagination" id="member_blacklist_pagination" style="display:flex; justify-content:center">
	  			<!-- 
