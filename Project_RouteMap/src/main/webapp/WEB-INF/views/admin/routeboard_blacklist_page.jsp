...
<head>
	...
	<script src="${pageContext.request.contextPath}/resources/js/admin/routeboard_blacklist_page.js"></script>
</head>
          ...
          <div class="col-12">
            <div class="card">
            	<ul class="nav nav-tabs">
				  	<li class="nav-item">
			 	   		<a class="nav-link" href="${pageContext.request.contextPath}/admin/routeboard_list_page.do">루트공유 리스트</a>
				  	</li>
				  	<li class="nav-item">
				    	<a class="nav-link active" href="${pageContext.request.contextPath}/admin/routeboard_blacklist_page.do">신고 리스트</a>
				  	</li>	
				</ul>
             <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody id="route_blacklist">
                  	<!-- 신고 리스트 -->
                  </tbody>
                </table>
              </div>
              <div id="paginationbox">
	  			<ul class="pagination" id="route_blacklist_pagination" style="display:flex; justify-content:center">
	  			<!-- 
