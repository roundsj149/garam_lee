              ...
              <div class="col-md-8">
               ...
               <div class="post-container">
                  <div class="post-detail">
                    <div class="user-info">
                      <h5>보낸 사람&nbsp;<a class="custom-link" href="timeline.html" class="profile-link">${sendReadNote.send_member_id}</a></h5>
                      <p class="text-muted"><fmt:formatDate value="${sendReadNote.note_send_date}" pattern="yyyy.MM.dd HH:mm:ss" /></p>
                    </div>
                    <div class="line-divider"></div>
                    <div class="post-text">
                      <h6>${sendReadNote.note_title}</h6>
                      <p>${sendReadNote.note_content} <i class="em em-anguished"></i> <i class="em em-anguished"></i> <i class="em em-anguished"></i></p>
                    </div>
                    <div class="line-divider"></div>
                  </div>
               </div>
