...
<title>게시물 신고</title>
<script
	src="${pageContext.request.contextPath}/resources/js/report/report_location_page.js"></script>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/report/report_location_page.css">
</head>
<body>
	<div class="container" style="min-height:700px">
		...
		<div class="row">
			...
			<div class="col-8 py-5">
				<form id="frm"
					action="${pageContext.request.contextPath}/report/report_location_process.do" method="post">
					<div class="header" style="display: flex; flex-direction: column;">
						<h3>여행지/맛집 게시물 신고</h3>
						<br>
						<p class="advice highlight">
							<strong>여행지/맛집 게시물을 신고합니다</strong>
						</p>
						<p class="advice">
					...
					${locationboard_no }
						<input type="hidden" name="locationboard_no" value="${param.locationboard_no }">
						<input type="hidden" name="uri" value="${param.uri }">
						<input type="submit" value="신고" id="report_location" class="btn btn-success mr-1">
